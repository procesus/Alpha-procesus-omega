...
<body>
	<center><font class="titulo" face="Showcard Gothic" size="6">Tabla de los usuarios registrados actualmente.</font></center>
	<center>
        ...
        <tbody>
                ...
                $query = "SELECT * FROM reg_usuarios" ;
                  ...
                  while($row = $resultado->fetch_assoc())
                  {
                	...
                	$query3 = "SELECT * FROM estado WHERE id_estado = '$ffk_id_estado'";
				...
				echo "<td>$eestado - <a class='btn btn-warning' href=cambiar_estado.php?Documento=$ddocumento>Cambiar Estado</a></td>";	
				echo "<td><a class='btn btn-dark' href=modificar.php?Documento=$ddocumento>Modificar</a></td>";
...
<center>
<a class="btn btn-danger" href="../jefe.php">&nbsp;<font size="4">Atras.</font></a>
<a class="btn btn-success" href="index.php">&nbsp;<font size="4">Nuevo.</font></a>
</center>
