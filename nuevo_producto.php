...
<input autocomplete="OFF" class="input-100"  type="text" name="cod_producto" placeholder="CODIGO DEL PRODUCTO" required=""><br>

<center><font class="titulo2" face="Showcard Gothic">Descripcion-producto</font></center>
<input autocomplete="OFF" class="input-100"  type="text" name="descripcion" placeholder="DESCRIPCION DEL PRODUCTO" required=""><br>

<center><font class="titulo2" face="Showcard Gothic">Precio-producto</font></center>
<input autocomplete="OFF" class="input-100"  type="text" name="precio" placeholder="PRECIO DEL PRODUCTO" required pattern="[0-9]{1,15}"><br>
...
<center>
    ...
    <div class="informacion">
        <input class="input-100"  type="file" name="img" required="">
    </div>
    </div>
</center>
