...
//Valida los datos del formulario de "NUEVO" y guarda los datos en la tabla producto 
if(isset($_FILES['img'])){
...
$query = "INSERT INTO producto (cod_producto, descripcion, precio, fk_provedor, fk_categoria, fk_estado_producto, imagen) VALUES ('$cod_producto', '$descripcion', '$precio', '$fk_provedor', '$fk_categoria', 1, '$destino')";
